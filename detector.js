...
const BOOKS = {
  ...
  esdras: ['esdras', 'livre d esdras', 'esd'], nehemie: ['nehemie', 'livre de nehemie', 'ne'],
  esther: ['esther', 'livre d esther', 'est'], job: ['job', 'livre de job', 'jb'],
  ...
  osee: ['osee', 'os', 'livre d osee', 'prophete osee'], joel: ['joel', 'jl', 'livre de joel', 'prophete joel'],
  amos: ['amos', 'am', 'livre d amos', 'prophete amos'], abdias: ['abdias', 'ab', 'livre d abdias', 'prophete abdias'],
  jonas: ['jonas', 'jon', 'livre de jonas', 'prophete jonas'], michee: ['michee', 'mi', 'livre de michee', 'prophete michee'], nahum: ['nahum', 'na', 'livre de nahum', 'prophete nahum'],
  habacuc: ['habacuc', 'ha', 'livre d habacuc', 'prophete habacuc'], sophonie: ['sophonie', 'so', 'livre de sophonie', 'prophete sophonie'], aggee: ['aggee', 'ag', 'livre d aggee', 'prophete aggee'],
  zacharie: ['zacharie', 'za', 'livre de zacharie', 'prophete zacharie'], malachie: ['malachie', 'ml', 'livre de malachie', 'prophete malachie'],
  ...
  tite: ['tite', 'epitre a tite', 'lettre a tite', 'tt'], philemon: ['philemon', 'epitre a philemon', 'lettre a philemon', 'phm'],
