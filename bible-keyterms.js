...
const SPOKEN_FORMS_FR = [
  'premier Samuel', 'deuxième Samuel', 'premier Rois', 'deuxième Rois',
  'premier Chroniques', 'deuxième Chroniques', 'premier Corinthiens',
  'deuxième Corinthiens', 'premier Thessaloniciens', 'deuxième Thessaloniciens',
  'premier Timothée', 'deuxième Timothée', 'premier Pierre', 'deuxième Pierre',
  'premier Jean', 'deuxième Jean', 'troisième Jean',
];
...
const THEOLOGICAL_TERMS_FR = [
  'justification', 'sanctification', 'propitiation', 'eschatologie',
  'expiation', 'rédemption', 'justice', 'alliance', 'baptême',
  'résurrection', 'crucifixion', 'salut', 'repentance', 'grâce',
  'miséricorde', 'pardon', 'réconciliation', 'glorification',
  'prédestination', 'souveraineté', 'omniscience', 'omnipotence',
  'trinité', 'incarnation', 'ascension', 'transfiguration', 'béatitudes',
  'tabernacle', "arche de l'alliance", 'Melchisédek', 'Nabuchodonosor',
  'chapitre', 'verset', 'Segond', 'Darby',
];
...
function buildWhisperPrompt() {
  return (
    ...
    BOOK_NAMES_FR.join(', ') +
    '. Formes parlées : ' + SPOKEN_FORMS_FR.join(', ') + '.'
  );
}
