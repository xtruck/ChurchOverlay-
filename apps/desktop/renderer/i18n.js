...
;(function () {
  const DICTIONARIES = {
    en: {
      ...
      "rundown.builder.canvasPlaceholder": "Adds an empty canvas scene — the visual layout editor is coming soon.",
    ...
    fr: {
      ...
      "rundown.builder.canvasPlaceholder": "Ajoute une scène libre vide — l'éditeur visuel de mise en page arrive bientôt.",
