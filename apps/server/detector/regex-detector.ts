 ...
 *
 * Recognizes the explicit "Book Chapter:Verse" pattern: one or more
 * capitalized words (optionally prefixed by 1/2/3, e.g. "1 Corinthians"),
...
const REFERENCE_PATTERN =
  /\b((?:[123]\s+)?[A-Z][A-Za-z]+(?:\s+[A-Z][A-Za-z]+)*)\s+(\d{1,3}):(\d{1,3})\b/g
